...
try:
    from ds_part13 import EXTRA_DATA_9
except ImportError:
    EXTRA_DATA_9 = []

try:
    from ds_part14 import EXTRA_DATA_10
except ImportError:
    EXTRA_DATA_10 = []

try:
    from ds_part15 import EXTRA_DATA_11
except ImportError:
    EXTRA_DATA_11 = []

try:
    from ds_part16 import EXTRA_DATA_12
except ImportError:
    EXTRA_DATA_12 = []
...
ALL_EXTRA      = EXTRA_DATA + EXTRA_DATA_2 + EXTRA_DATA_3 + EXTRA_DATA_4 + EXTRA_DATA_5 + EXTRA_DATA_6 + EXTRA_DATA_7 + EXTRA_DATA_8 + EXTRA_DATA_9 + EXTRA_DATA_10 + EXTRA_DATA_11 + EXTRA_DATA_12
